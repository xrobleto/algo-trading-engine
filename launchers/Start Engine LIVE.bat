...
echo   Unified Engine: TREND + SIMPLE
echo  =============================================
echo.
...
REM Load trend bot live env (primary account keys)
...
:loop
echo [%date% %time%] Starting Unified Engine (LIVE)...
echo.
echo Commands:
echo   --trend-only   Run with Trend adapter only (no Simple Bot)
echo   --status       Show engine state and exit
echo.
